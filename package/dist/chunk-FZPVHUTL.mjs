...
function getSdk2(requester) {
  return {
    ...
    companies: {
      getCompanyAuthorizedUsers(variables, options) {
        return requester(
          "whop-sdk-ts-server/sha256:ce11d90e9adc2974e352a10641ce6f3faf0ed658f918e6d9afe78d03e4c1a5e4",
          "getCompanyAuthorizedUsers",
          "query",
          variables,
          options
        ).then((res) => res.company);
      ...
      listMembers(variables, options) {
        return requester(
          "whop-sdk-ts-server/sha256:34337a3e4ebfccad229ae02c0c7b29087c0940bcf77ce083653a131408736491",
          "listMembers",
          "query",
          variables,
          options
...
//# sourceMappingURL=chunk-FZPVHUTL.mjs.map