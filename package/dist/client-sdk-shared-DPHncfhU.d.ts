...
declare function getSdk$1<C>(requester: Requester$1<C>): {
    accessPasses: {
        getAccessPass(variables: GetAccessPassQueryVariables$1, options?: C): Promise<GetAccessPassQuery$1["accessPass"]>;
    };
    attachments: {
        getAttachment(variables: GetAttachmentQueryVariables$1, options?: C): Promise<GetAttachmentQuery$1["attachment"]>;
        processAttachment(variables: ProcessAttachmentMutationVariables$1["input"], options?: C): Promise<ProcessAttachmentMutation$1["mediaAnalyzeAttachment"]>;
        uploadMedia(variables: UploadMediaMutationVariables$1["input"], options?: C): Promise<UploadMediaMutation$1["mediaDirectUpload"]>;
    };
    companies: {
        getCompany(variables: GetCompanyQueryVariables$1, options?: C): Promise<GetCompanyQuery$1["company"]>;
    };
    courses: {
        createAssessmentQuestion(variables: CreateAssessmentQuestionMutationVariables$1["input"], options?: C): Promise<CreateAssessmentQuestionMutation$1["createAssessmentQuestion"]>;
        createChapter(variables: CreateChapterMutationVariables$1["input"], options?: C): Promise<CreateChapterMutation$1["createChapter"]>;
        createCourse(variables: CreateCourseMutationVariables$1["input"], options?: C): Promise<CreateCourseMutation$1["createCourse"]>;
        createLesson(variables: CreateLessonMutationVariables$1["input"], options?: C): Promise<CreateLessonMutation$1["createLesson"]>;
        deleteAssessmentQuestionImage(variables: DeleteAssessmentQuestionImageMutationVariables$1["input"], options?: C): Promise<DeleteAssessmentQuestionImageMutation$1["deleteAssessmentQuestionImage"]>;
        deleteChapter(variables: DeleteChapterMutationVariables$1["input"], options?: C): Promise<DeleteChapterMutation$1["deleteChapter"]>;
        deleteLessonAttachment(variables: DeleteLessonAttachmentMutationVariables$1["input"], options?: C): Promise<DeleteLessonAttachmentMutation$1["deleteLessonAttachment"]>;
        deleteLesson(variables: DeleteLessonMutationVariables$1["input"], options?: C): Promise<DeleteLessonMutation$1["deleteLesson"]>;
        getCourse(variables: GetCourseQueryVariables$1, options?: C): Promise<GetCourseQuery$1["course"]>;
        getLesson(variables: GetLessonQueryVariables$1, options?: C): Promise<GetLessonQuery$1["course"]>;
        getUserLessonInteractions(variables: GetUserLessonInteractionsQueryVariables$1, options?: C): Promise<GetUserLessonInteractionsQuery$1["course"]>;
        listCoursesForCompany(variables: ListCoursesForCompanyQueryVariables$1, options?: C): Promise<ListCoursesForCompanyQuery$1["company"]>;
        listCoursesForExperience(variables: ListCoursesForExperienceQueryVariables$1, options?: C): Promise<ListCoursesForExperienceQuery$1["publicExperience"]>;
        markLessonAsCompleted(variables: MarkLessonAsCompletedMutationVariables$1["input"], options?: C): Promise<MarkLessonAsCompletedMutation$1["markLessonAsCompleted"]>;
        moveCourse(variables: MoveCourseMutationVariables$1["input"], options?: C): Promise<MoveCourseMutation$1["moveCourse"]>;
        updateChapterOrder(variables: UpdateChapterOrderMutationVariables$1["input"], options?: C): Promise<UpdateChapterOrderMutation$1["updateChapterOrder"]>;
        updateChapter(variables: UpdateChapterMutationVariables$1["input"], options?: C): Promise<UpdateChapterMutation$1["updateChapter"]>;
        updateLessonOrder(variables: UpdateLessonOrderMutationVariables$1["input"], options?: C): Promise<UpdateLessonOrderMutation$1["updateLessonOrder"]>;
        updateLesson(variables: UpdateLessonMutationVariables$1["input"], options?: C): Promise<UpdateLessonMutation$1["updateLesson"]>;
    };
    experiences: {
        getExperience(variables: GetExperienceQueryVariables$1, options?: C): Promise<GetExperienceQuery$1["experience"]>;
        listUsersForExperience(variables: ListUsersForExperienceQueryVariables$1, options?: C): Promise<ListUsersForExperienceQuery$1["publicExperience"]>;
    };
    forums: {
        listForumPostsFromForum(variables: ListForumPostsFromForumQueryVariables$1, options?: C): Promise<ListForumPostsFromForumQuery$1["feedPosts"]>;
    };
    messages: {
        listMessagesFromChat(variables?: ListMessagesFromChatQueryVariables$1, options?: C): Promise<ListMessagesFromChatQuery$1["feedPosts"]>;
    };
    users: {
        getCurrentUser(variables?: GetCurrentUserQueryVariables$1, options?: C): Promise<GetCurrentUserQuery$1["viewer"]>;
        getUserLedgerAccount(variables?: GetUserLedgerAccountQueryVariables$1, options?: C): Promise<GetUserLedgerAccountQuery$1["viewer"]>;
        getUser(variables: GetUserQueryVariables$1, options?: C): Promise<GetUserQuery$1["publicUser"]>;
    };
};
...
type LeaderboardTypes = "affiliate_earnings" | "average_time_spent" | "competition" | "money_earned_last_7_days" | "money_earned_last_24_hours" | "money_earned_last_30_days" | "new_users" | "top_rated" | "total_time_spent" | "usd_gmv" | "whop_partners_earnings_last_30_days" | "whop_partners_gtv_last_30_days";
/** Which columns can be used to sort. */
...
type GetCompanyAuthorizedUsersQueryVariables = Exact<{
    companyId: Scalars["ID"]["input"];
}>;
type GetCompanyAuthorizedUsersQuery = {
    __typename?: "PublicQuery";
    company?: {
        __typename?: "Company";
...
type GetWaitlistEntriesForCompanyQueryVariables = Exact<{
    companyId: Scalars["ID"]["input"];
...
type GetWaitlistEntriesForCompanyQuery = {
    __typename?: "PublicQuery";
    company?: {
        __typename?: "Company";
...
declare function getSdk<C>(requester: Requester<C>): {
    accessPasses: {
        getAccessPass(variables: GetAccessPassQueryVariables, options?: C): Promise<GetAccessPassQuery["accessPass"]>;
    };
    access: {
        checkIfUserHasAccessToAccessPass(variables: CheckIfUserHasAccessToAccessPassQueryVariables, options?: C): Promise<CheckIfUserHasAccessToAccessPassQuery["hasAccessToAccessPass"]>;
        checkIfUserHasAccessToCompany(variables: CheckIfUserHasAccessToCompanyQueryVariables, options?: C): Promise<CheckIfUserHasAccessToCompanyQuery["hasAccessToCompany"]>;
        checkIfUserHasAccessToExperience(variables: CheckIfUserHasAccessToExperienceQueryVariables, options?: C): Promise<CheckIfUserHasAccessToExperienceQuery["hasAccessToExperience"]>;
    };
    apps: {
        createAppBuild(variables: CreateAppBuildMutationVariables["input"], options?: C): Promise<CreateAppBuildMutation["createAppBuild"]>;
    };
    attachments: {
        getAttachment(variables: GetAttachmentQueryVariables, options?: C): Promise<GetAttachmentQuery["attachment"]>;
        processAttachment(variables: ProcessAttachmentMutationVariables["input"], options?: C): Promise<ProcessAttachmentMutation["mediaAnalyzeAttachment"]>;
        uploadMedia(variables: UploadMediaMutationVariables["input"], options?: C): Promise<UploadMediaMutation["mediaDirectUpload"]>;
    };
    companies: {
        getCompanyAuthorizedUsers(variables: GetCompanyAuthorizedUsersQueryVariables, options?: C): Promise<GetCompanyAuthorizedUsersQuery["company"]>;
        getCompanyLedgerAccount(variables: GetCompanyLedgerAccountQueryVariables, options?: C): Promise<GetCompanyLedgerAccountQuery["company"]>;
        getCompany(variables: GetCompanyQueryVariables, options?: C): Promise<GetCompanyQuery["company"]>;
        getWaitlistEntriesForCompany(variables: GetWaitlistEntriesForCompanyQueryVariables, options?: C): Promise<GetWaitlistEntriesForCompanyQuery["company"]>;
        listMembers(variables: ListMembersQueryVariables, options?: C): Promise<ListMembersQuery["company"]>;
    };
    courses: {
        createAssessmentQuestion(variables: CreateAssessmentQuestionMutationVariables["input"], options?: C): Promise<CreateAssessmentQuestionMutation["createAssessmentQuestion"]>;
        createChapter(variables: CreateChapterMutationVariables["input"], options?: C): Promise<CreateChapterMutation["createChapter"]>;
        createCourse(variables: CreateCourseMutationVariables["input"], options?: C): Promise<CreateCourseMutation["createCourse"]>;
        createLesson(variables: CreateLessonMutationVariables["input"], options?: C): Promise<CreateLessonMutation["createLesson"]>;
        deleteAssessmentQuestionImage(variables: DeleteAssessmentQuestionImageMutationVariables["input"], options?: C): Promise<DeleteAssessmentQuestionImageMutation["deleteAssessmentQuestionImage"]>;
        deleteChapter(variables: DeleteChapterMutationVariables["input"], options?: C): Promise<DeleteChapterMutation["deleteChapter"]>;
        deleteLessonAttachment(variables: DeleteLessonAttachmentMutationVariables["input"], options?: C): Promise<DeleteLessonAttachmentMutation["deleteLessonAttachment"]>;
        deleteLesson(variables: DeleteLessonMutationVariables["input"], options?: C): Promise<DeleteLessonMutation["deleteLesson"]>;
        getCourse(variables: GetCourseQueryVariables, options?: C): Promise<GetCourseQuery["course"]>;
        getLesson(variables: GetLessonQueryVariables, options?: C): Promise<GetLessonQuery["course"]>;
        getUserLessonInteractions(variables: GetUserLessonInteractionsQueryVariables, options?: C): Promise<GetUserLessonInteractionsQuery["course"]>;
        listCoursesForCompany(variables: ListCoursesForCompanyQueryVariables, options?: C): Promise<ListCoursesForCompanyQuery["company"]>;
        listCoursesForExperience(variables: ListCoursesForExperienceQueryVariables, options?: C): Promise<ListCoursesForExperienceQuery["publicExperience"]>;
        markLessonAsCompleted(variables: MarkLessonAsCompletedMutationVariables["input"], options?: C): Promise<MarkLessonAsCompletedMutation["markLessonAsCompleted"]>;
        moveCourse(variables: MoveCourseMutationVariables["input"], options?: C): Promise<MoveCourseMutation["moveCourse"]>;
        updateChapterOrder(variables: UpdateChapterOrderMutationVariables["input"], options?: C): Promise<UpdateChapterOrderMutation["updateChapterOrder"]>;
        updateChapter(variables: UpdateChapterMutationVariables["input"], options?: C): Promise<UpdateChapterMutation["updateChapter"]>;
        updateLessonOrder(variables: UpdateLessonOrderMutationVariables["input"], options?: C): Promise<UpdateLessonOrderMutation["updateLessonOrder"]>;
        updateLesson(variables: UpdateLessonMutationVariables["input"], options?: C): Promise<UpdateLessonMutation["updateLesson"]>;
    };
    experiences: {
        getExperience(variables: GetExperienceQueryVariables, options?: C): Promise<GetExperienceQuery["experience"]>;
        listAccessPassesForExperience(variables: ListAccessPassesForExperienceQueryVariables, options?: C): Promise<ListAccessPassesForExperienceQuery["experience"]>;
        listExperiences(variables: ListExperiencesQueryVariables, options?: C): Promise<ListExperiencesQuery["company"]>;
        listUsersForExperience(variables: ListUsersForExperienceQueryVariables, options?: C): Promise<ListUsersForExperienceQuery["publicExperience"]>;
    };
    forums: {
        createForumPost(variables: CreateForumPostMutationVariables["input"], options?: C): Promise<CreateForumPostMutation["createForumPost"]>;
        findOrCreateForum(variables: FindOrCreateForumMutationVariables["input"], options?: C): Promise<FindOrCreateForumMutation["createForum"]>;
        listForumPostsFromForum(variables: ListForumPostsFromForumQueryVariables, options?: C): Promise<ListForumPostsFromForumQuery["feedPosts"]>;
    };
    messages: {
        findOrCreateChat(variables: FindOrCreateChatMutationVariables["input"], options?: C): Promise<FindOrCreateChatMutation["createChat"]>;
        listDirectMessageConversations(variables?: ListDirectMessageConversationsQueryVariables, options?: C): Promise<ListDirectMessageConversationsQuery["myDmsChannelsV2"]>;
        listMessagesFromChat(variables?: ListMessagesFromChatQueryVariables, options?: C): Promise<ListMessagesFromChatQuery["feedPosts"]>;
        sendDirectMessageToUser(variables: SendDirectMessageToUserMutationVariables, options?: C): Promise<SendDirectMessageToUserMutation["sendMessage"]>;
        sendMessageToChat(variables: SendMessageToChatMutationVariables, options?: C): Promise<SendMessageToChatMutation["sendMessage"]>;
    };
    notifications: {
        sendPushNotification(variables: SendPushNotificationMutationVariables["input"], options?: C): Promise<SendPushNotificationMutation["sendNotification"]>;
    };
    payments: {
        chargeUser(variables: ChargeUserMutationVariables["input"], options?: C): Promise<ChargeUserMutation["chargeUser"]>;
        createCheckoutSession(variables: CreateCheckoutSessionMutationVariables["input"], options?: C): Promise<CreateCheckoutSessionMutation["createCheckoutSession"]>;
        listReceiptsForCompany(variables: ListReceiptsForCompanyQueryVariables, options?: C): Promise<ListReceiptsForCompanyQuery["company"]>;
        payUser(variables: PayUserMutationVariables["input"], options?: C): Promise<PayUserMutation["transferFunds"]>;
    };
    users: {
        getCurrentUser(variables?: GetCurrentUserQueryVariables, options?: C): Promise<GetCurrentUserQuery["viewer"]>;
        getUserLedgerAccount(variables?: GetUserLedgerAccountQueryVariables, options?: C): Promise<GetUserLedgerAccountQuery["viewer"]>;
        getUser(variables: GetUserQueryVariables, options?: C): Promise<GetUserQuery["publicUser"]>;
    };
};
...
declare function BaseWhopServerSdk(options: WhopServerSdkOptions, uploadFile: ReturnType<typeof makeUploadAttachmentFunction>): {
    ...
    access: {
        checkIfUserHasAccessToAccessPass(variables: Exact<{
            accessPassId: Scalars["ID"]["input"];
            userId?: InputMaybe<Scalars["ID"]["input"]>;
        }>, options?: RequestInit | undefined): Promise<CheckIfUserHasAccessToAccessPassQuery["hasAccessToAccessPass"]>;
        checkIfUserHasAccessToCompany(variables: Exact<{
            companyId: Scalars["ID"]["input"];
            userId?: InputMaybe<Scalars["ID"]["input"]>;
        }>, options?: RequestInit | undefined): Promise<CheckIfUserHasAccessToCompanyQuery["hasAccessToCompany"]>;
        checkIfUserHasAccessToExperience(variables: Exact<{
            experienceId: Scalars["ID"]["input"];
            userId?: InputMaybe<Scalars["ID"]["input"]>;
        }>, options?: RequestInit | undefined): Promise<CheckIfUserHasAccessToExperienceQuery["hasAccessToExperience"]>;
    };
    apps: {
        createAppBuild(variables: CreateAppBuildInput, options?: RequestInit | undefined): Promise<CreateAppBuildMutation["createAppBuild"]>;
    };
    companies: {
        getCompanyAuthorizedUsers(variables: Exact<{
            companyId: Scalars["ID"]["input"];
        }>, options?: RequestInit | undefined): Promise<GetCompanyAuthorizedUsersQuery["company"]>;
        getCompanyLedgerAccount(variables: Exact<{
            companyId: Scalars["ID"]["input"];
        }>, options?: RequestInit | undefined): Promise<GetCompanyLedgerAccountQuery["company"]>;
        getCompany(variables: Exact<{
            companyId: Scalars["ID"]["input"];
        }>, options?: RequestInit | undefined): Promise<GetCompanyQuery["company"]>;
        getWaitlistEntriesForCompany(variables: Exact<{
            companyId: Scalars["ID"]["input"];
            after?: InputMaybe<Scalars["String"]["input"]>;
            before?: InputMaybe<Scalars["String"]["input"]>;
            first?: InputMaybe<Scalars["Int"]["input"]>;
            last?: InputMaybe<Scalars["Int"]["input"]>;
        }>, options?: RequestInit | undefined): Promise<GetWaitlistEntriesForCompanyQuery["company"]>;
        listMembers(variables: Exact<{
            ...
            order?: InputMaybe<MembersSortableColumns>;
            filters?: InputMaybe<MembersFiltersInput>;
        }>, options?: RequestInit | undefined): Promise<ListMembersQuery["company"]>;
    };
    courses: {
    ...
    experiences: {
        ...
        listAccessPassesForExperience(variables: Exact<{
            experienceId: Scalars["ID"]["input"];
        }>, options?: RequestInit | undefined): Promise<ListAccessPassesForExperienceQuery["experience"]>;
        listExperiences(variables: Exact<{
            ...
            onAccessPass?: InputMaybe<Scalars["Boolean"]["input"]>;
            companyId: Scalars["ID"]["input"];
        }>, options?: RequestInit | undefined): Promise<ListExperiencesQuery["company"]>;
    ...
    forums: {
        createForumPost(variables: CreateForumPostInput, options?: RequestInit | undefined): Promise<CreateForumPostMutation["createForumPost"]>;
        findOrCreateForum(variables: CreateForumInput, options?: RequestInit | undefined): Promise<FindOrCreateForumMutation["createForum"]>;
        listForumPostsFromForum(variables: Exact<{
            experienceId: Scalars["ID"]["input"];
        }>, options?: RequestInit | undefined): Promise<ListForumPostsFromForumQuery["feedPosts"]>;
    };
    messages: {
        findOrCreateChat(variables: CreateChatInput, options?: RequestInit | undefined): Promise<FindOrCreateChatMutation["createChat"]>;
        listDirectMessageConversations(variables?: Exact<{
            ...
            status?: InputMaybe<DmsFeedMemberStatuses>;
            unread?: InputMaybe<Scalars["Boolean"]["input"]>;
        }> | undefined, options?: RequestInit | undefined): Promise<ListDirectMessageConversationsQuery["myDmsChannelsV2"]>;
        ...
        sendDirectMessageToUser(variables: Exact<{
            toUserIdOrUsername: Scalars["ID"]["input"];
            message: Scalars["String"]["input"];
        }>, options?: RequestInit | undefined): Promise<SendDirectMessageToUserMutation["sendMessage"]>;
        sendMessageToChat(variables: Exact<{
            experienceId: Scalars["ID"]["input"];
            message: Scalars["String"]["input"];
        }>, options?: RequestInit | undefined): Promise<SendMessageToChatMutation["sendMessage"]>;
    };
    notifications: {
        sendPushNotification(variables: SendNotificationInput, options?: RequestInit | undefined): Promise<SendPushNotificationMutation["sendNotification"]>;
    };
    payments: {
        chargeUser(variables: ChargeUserInput, options?: RequestInit | undefined): Promise<ChargeUserMutation["chargeUser"]>;
        createCheckoutSession(variables: CreateCheckoutSessionInput, options?: RequestInit | undefined): Promise<CreateCheckoutSessionMutation["createCheckoutSession"]>;
        listReceiptsForCompany(variables: Exact<{
            companyId: Scalars["ID"]["input"];
            first?: InputMaybe<Scalars["Int"]["input"]>;
            after?: InputMaybe<Scalars["String"]["input"]>;
            filter?: InputMaybe<ReceiptV2Filters>;
        }>, options?: RequestInit | undefined): Promise<ListReceiptsForCompanyQuery["company"]>;
        payUser(variables: TransferFundsInput, options?: RequestInit | undefined): Promise<PayUserMutation["transferFunds"]>;
    };
    users: {
...
export { type ListMessagesFromChatQuery$1 as $, type AttachableRecords$1 as A, type MarkLessonAsCompletedMutation$1 as B, type CreateAssessmentQuestionInput$1 as C, type DirectUploadInput$1 as D, type Exact$1 as E, type MoveCourseInput$1 as F, type GetAttachmentQuery$1 as G, type MoveCourseMutation$1 as H, type InputMaybe$1 as I, type UpdateChapterOrderInput$1 as J, type UpdateChapterOrderMutation$1 as K, type ListCoursesForCompanyQuery$1 as L, type MarkLessonAsCompletedInput$1 as M, type UpdateChapterInput$1 as N, type UpdateChapterMutation$1 as O, type ProcessAttachmentMutation$1 as P, type UpdateLessonOrderInput$1 as Q, type UpdateLessonOrderMutation$1 as R, type Scalars$1 as S, type UpdateLessonInput$1 as T, type UploadFileOptions as U, type UpdateLessonMutation$1 as V, type WhopClientSdkOptions as W, type GetExperienceQuery$1 as X, type Direction$1 as Y, type ListUsersForExperienceQuery$1 as Z, type ListForumPostsFromForumQuery$1 as _, type UploadAttachmentResponse as a, type ApplicationCriteriaIdentifier as a$, type GetCurrentUserQuery$1 as a0, type GetUserLedgerAccountQuery$1 as a1, type GetUserQuery$1 as a2, type WhopServerSdkOptions as a3, type WhopServerSdk as a4, index as a5, getUserToken as a6, makeUserTokenVerifier as a7, verifyUserToken as a8, type UserTokenPayload as a9, type AcceptedPaymentMethods as aA, type AccessLevel as aB, type AccessPassAffiliateOrder as aC, type AccessPassAffiliateStatuses as aD, type AccessPassAttachmentCategories as aE, type AccessPassConditions as aF, type AccessPassFilters as aG, type AccessPassOnboardingVersionTypes as aH, type AccessPassOrder as aI, type AccessPassTypes as aJ, type AccessPassesSortableColumns as aK, type AffiliatePayoutTypes as aL, type AffiliatePlansSortableColumns as aM, type AffiliateReferralLogFilters as aN, type AffiliateReferralLogsSortableColumns as aO, type AffiliateTypes as aP, type AffiliatesSortableColumns as aQ, type AnalyzeAttachmentInput as aR, type ApiKeyPermissions as aS, type ApiVersion as aT, type AppBuildPlatforms as aU, type AppBuildStatuses as aV, type AppImageStyles as aW, type AppRequestedPermissionInput as aX, type AppStatuses as aY, type AppValidScopes as aZ, type AppViewTypes as a_, type VerifyUserTokenOptions as aa, type DisputeWebhookData as ab, type MembershipWebhookData as ac, type PaymentWebhookData as ad, type RefundWebhookData as ae, makeWebhookValidator as af, type WhopWebhookRequestBody as ag, type ReceivableWebsocketMessage as ah, type SendableWebsocketMessage as ai, type WebsocketBroadcastTarget as aj, type WebsocketMessageHandler as ak, type WebsocketStatus as al, type WebsocketStatusHandler as am, WhopWebsocketClientBase as an, WhopWebsocketClientServer as ao, type Maybe as ap, type InputMaybe as aq, type Exact as ar, type MakeOptional as as, type MakeMaybe as at, type MakeEmpty as au, type Incremental as av, type Scalars as aw, type AbuseReportCategoryResourceTypes as ax, type AbuseReportCategoryVisibility as ay, type AbuseReportStatus as az, type AnalyzeAttachmentInput$1 as b, type CreateForumInput as b$, type AttachableRecords as b0, type AttachmentInput as b1, type AuditLogsSortableColumns as b2, type AuthenticationMethods as b3, type AuthorizationResourceTypes as b4, type AuthorizedUserRoles as b5, type AutomatedMessagesTriggerCategories as b6, type AvatarImageStyles as b7, type BalanceReservationReservationTypes as b8, type BanReasons as b9, type ConnectedAccountTypes as bA, type ContentRewardsCampaignOrder as bB, type ContentRewardsCampaignStatus as bC, type ContentRewardsCampaignsFilters as bD, type ContentRewardsCategory as bE, type ContentRewardsContentType as bF, type ContentRewardsPlatform as bG, type ContentRewardsPublicCampaignOrder as bH, type ContentRewardsPublicCampaignsFilters as bI, type ContentRewardsSubmissionAnalysisResults as bJ, type ContentRewardsSubmissionFlagReasons as bK, type ContentRewardsSubmissionStatus as bL, type ContentRewardsSubmissionViewsChartConfigInput as bM, type ContentRewardsSubmissionsFilters as bN, type ContentRewardsSubmissionsOrder as bO, type ContentRewardsSubmissionsSortableColumns as bP, type ContentRewardsViewsChartConfigInput as bQ, type CoursesAssessmentQuestionTypes as bR, type CreateAgentUserInput as bS, type CreateAppBuildInput as bT, type CreateAppInput as bU, type CreateAssessmentQuestionInput as bV, type CreateChapterInput as bW, type CreateChatInput as bX, type CreateCheckoutSessionInput as bY, type CreateCompanyMutedUserInput as bZ, type CreateCourseInput as b_, type BanUserInput as ba, type BillingReasons as bb, type BnplProvider as bc, type BountyFilters as bd, type BusinessActivityEventTypes as be, type BusinessAffiliateImageStyles as bf, type BusinessTypes as bg, type BuyerFeeMode as bh, type CancelOptions as bi, type CaseStates as bj, type ChangeCardMyMembershipInput as bk, type ChargeCardFunding as bl, type ChargeOutcomeRiskLevels as bm, type ChargeUserInput as bn, type ChargeUserResponseStatus as bo, type ChartIntervals as bp, type ChatFeedInput as bq, type CheckoutSessionTypes as br, type CoinbaseCommerceStatuses as bs, type CompaniesOrder as bt, type CompanyAttachmentCategories as bu, type CompanyImageStyles as bv, type CompanyTypes as bw, type CompetitionMetricTypes as bx, type CompetitionPrizeTypes as by, type ConnectedAccountStatuses as bz, type UploadMediaMutation$1 as c, type ForumLayoutTypes as c$, type CreateForumPostInput as c0, type CreateLessonInput as c1, type CreatePromoCodeInput as c2, type CreateWebhookInput as c3, type CreatorDashboardCancelationDiscounts as c4, type CreatorDashboardChartConfigInput as c5, type CreatorDashboardChartIntervals as c6, type CreditTransactionActivityTypes as c7, type CreditTransactionFilters as c8, type CreditTransactionStatuses as c9, type DmsFeedInput as cA, type DmsFeedMemberInput as cB, type DmsFeedMemberNotificationPreferences as cC, type DmsFeedMemberStatuses as cD, type DmsFeedTypes as cE, type DmsPostInput as cF, type DmsPostTypes as cG, type EarningsReportPeriods as cH, type EarningsTypes as cI, type EntityTypes as cJ, type EntriesSortableColumns as cK, type EntryFilters as cL, type EntryOrder as cM, type EntryStatus as cN, type EntryTypes as cO, type ExperienceAccessLevels as cP, type ExperienceActivityCardTypes as cQ, type ExperienceFilters as cR, type ExperienceLinkModes as cS, type ExperienceTypes as cT, type FeedTypes as cU, type FileAttachmentInput as cV, type FileAttachmentModerationResultsTypes as cW, type FileAttachmentTypes as cX, type FlashSaleDurations as cY, type FlashSaleStatuses as cZ, type ForumEmailNotificationPreferences as c_, type CreditTransactionTransferReasons as ca, type CreditTransactionTransferStatuses as cb, type CreditTransactionTransferTypes as cc, type CreditTransactionTransfersSortableColumns as cd, type CryptoWalletNetworks as ce, type Currencies as cf, type CustomCtas as cg, type CustomFieldInput as ch, type CustomFieldTypes as ci, type DeleteAssessmentQuestionImageInput as cj, type DeleteChapterInput as ck, type DeleteCompanyMutedUserInput as cl, type DeleteLessonAttachmentInput as cm, type DeleteLessonInput as cn, type DeletePromoCodeInput as co, type DeleteWebhookInput as cp, type Device as cq, type DirectMessageStatus as cr, type DirectUploadInput as cs, type Direction as ct, type DiscordAccountImageStyles as cu, type DiscoverStatuses as cv, type DisputeRiskLevels as cw, type DisputeStatuses as cx, type DisputesSortableColumns as cy, type DmsChannelsSortTypes as cz, type WebsocketClientOptionsClient as d, type OpengraphImageVariants as d$, type ForumPostTypes as d0, type ForumWhoCanCommentTypes as d1, type ForumWhoCanPostTypes as d2, type FriendlyReceiptStatus as d3, type GatewayTypes as d4, type GifInput as d5, type GifProviders as d6, type GlobalAffiliateStatuses as d7, type HubMembershipStatus as d8, type ImageAttachmentVariants as d9, type MarketplaceStatuses as dA, type Media as dB, type MemberMostRecentActions as dC, type MemberStatuses as dD, type MemberSubtextTypes as dE, type MembersFiltersInput as dF, type MembersSortableColumns as dG, type MembershipActions as dH, type MembershipHeaderStatus as dI, type MembershipImageStyles as dJ, type MembershipPaymentProcessor as dK, type MembershipPushNotification as dL, type MembershipStatus as dM, type MembershipsSortableColumns as dN, type ModerationResults as dO, type MoveCourseInput as dP, type MutedUserInput as dQ, type MuxAssetStatuses as dR, type NormalizedAccountTypes as dS, type NotificationPreferenceChannel as dT, type NotificationPreferencesFilters as dU, type NotificationTopicStatus as dV, type NotificationTopicVisibility as dW, type NotificationsV4Filters as dX, type NotificationsV4Pagination as dY, type OnboardingProviders as dZ, type OnboardingTypes as d_, type ImageExtensions as da, type ImageImageStyles as db, type IndustryTypes as dc, type InstantPayoutErrorCodes as dd, type ItemOrderingOrderTypes as de, type Languages as df, type LeaderboardTypes as dg, type LeadsSortableColumns as dh, type LedgerAccountStandings as di, type LedgerTypes as dj, type LedgerWithdrawalFrequencies as dk, type LedgerWithdrawalStatuses as dl, type LessonTypes as dm, type LessonVisibilities as dn, type LikedDiscoverAccessPassesOrder as dp, type LinkEmbedInput as dq, type LivestreamDestination as dr, type LivestreamFeedInput as ds, type LivestreamWhoCanPostTypes as dt, type LivestreamWhoCanReactTypes as du, type MadeForYouPlanFilters as dv, type ManagementItems as dw, type MarkLessonAsCompletedInput as dx, type MarketplaceCategoryOrder as dy, type MarketplaceCategoryTypes as dz, WhopWebsocketClientBrowser as e, type ReleaseMethod as e$, type PaymentMethods as e0, type PaymentProcessor as e1, type PaymentProviders as e2, type PaymentTransactionProviders as e3, type PaymentTransactionStatuses as e4, type PaymentTransactionTypes as e5, type PaymentsApprovalStatuses as e6, type PayoutAccountProviders as e7, type PayoutAccountStatuses as e8, type PayoutDeliveryTypes as e9, type ProductHighlightTypes as eA, type ProductImageStyles as eB, type ProductTaxCodeProductTypes as eC, type ProductUserFilters as eD, type ProductUserOrder as eE, type ProfileVisibilities as eF, type PromoCodeFilters as eG, type PromoCodeNewStatus as eH, type PromoCodeOrder as eI, type PromoCodeStatus as eJ, type PromoCodesSortableColumns as eK, type PromoDurations as eL, type PromoTypes as eM, type PromoteAppBuildToProductionInput as eN, type PublicAccessPassesOrder as eO, type PublicBountiesOrder as eP, type ReactionInput as eQ, type ReactionTypes as eR, type ReceiptFeeTypes as eS, type ReceiptPaymentProcessor as eT, type ReceiptStatus as eU, type ReceiptStatusV2 as eV, type ReceiptTaxBehaviors as eW, type ReceiptV2Filters as eX, type ReceiptV2Order as eY, type ReceiptsSortableColumns as eZ, type RefundStatuses as e_, type PayoutDestinationPlatformStatuses as ea, type PayoutDestinationProviders as eb, type PayoutDestinationStatuses as ec, type PayoutDestinationTypes as ed, type PayoutErrorCodes as ee, type PayoutIntervals as ef, type PayoutMethods as eg, type PayoutStatuses as eh, type PayoutTokenAttributeDataTypes as ei, type PayoutTokenAttributeInputTypes as ej, type PayoutTokenAttributeValueTypes as ek, type PayoutTokenProviders as el, type PayoutTokenStatuses as em, type PayoutTypes as en, type PaypalAccountStatuses as eo, type PerkStatus as ep, type PlanDirectLink as eq, type PlanFilters as er, type PlanOrder as es, type PlanTypes as et, type PlansOrder as eu, type PlansSortableColumns as ev, type PollInput as ew, type PollOptionInput as ex, type PostTypes as ey, type ProcessEntitiesInput as ez, type GetAccessPassQuery$1 as f, type UserAffiliateReferralLogFilters as f$, type ReportTypes as f0, type ResolutionActions as f1, type ResolutionCustomerResponses as f2, type ResolutionFilters as f3, type ResolutionIneligibilityReason as f4, type ResolutionIssueTypes as f5, type ResolutionMerchantResponses as f6, type ResolutionOrder as f7, type ResolutionPlatformResponses as f8, type ResolutionReporters as f9, type StripePayoutStatuses as fA, type StripePayoutTraceStatuses as fB, type TaxTypes as fC, type TerminateMyMembershipInput as fD, type TestWebhookV2Input as fE, type ToggleCancelMyMembershipInput as fF, type Topic as fG, type TrackingLinkDestination as fH, type TrackingLinksSortableColumns as fI, type TrackingPixelTypes as fJ, type TransferFundsInput as fK, type TransferLinkMyMembershipInput as fL, type UnassignProductionAppBuildInput as fM, type UnbanUserInput as fN, type UniversalPostFeedTypes as fO, type UpdateAgentUserInput as fP, type UpdateAppInput as fQ, type UpdateAppPermissionRequirementsInput as fR, type UpdateChapterInput as fS, type UpdateChapterOrderInput as fT, type UpdateLessonInput as fU, type UpdateLessonOrderInput as fV, type UpdateMembershipInput as fW, type UpdateWebhookInput as fX, type UploadPartInput as fY, type UpsellPlanInput as fZ, type UpsellTypes as f_, type ResolutionStatuses as fa, type ResolutionsSortableColumns as fb, type RestrictionSetReasonCodes as fc, type RetryPaymentMyMembershipInput as fd, type ReviewFilters as fe, type ReviewOrder as ff, type ReviewReportStatus as fg, type ReviewStatus as fh, type ReviewsSortableColumns as fi, type RewardUnits as fj, type RfiStatuses as fk, type SecurityLevels as fl, type SendMessageInput as fm, type SendNotificationInput as fn, type SimpleNotificationPreferenceStatus as fo, type SocialLinkWebsites as fp, type SpecificFeeOrigins as fq, type StatsConfigInput as fr, type Status as fs, type Statuses as ft, type StripeAccountStatuses as fu, type StripeAccountTypes as fv, type StripeBusinessTypes as fw, type StripeExternalAccountStatuses as fx, type StripePayoutMethods as fy, type StripePayoutPayoutTypes as fz, type GetCompanyQuery$1 as g, type CheckIfUserHasAccessToAccessPassQueryVariables as g$, type UserAffiliateReferralLogOrder as g0, type UserChartConfigInput as g1, type UserContentRewardsSubmissionsFilters as g2, type UserContentRewardsSubmissionsOrder as g3, type UserNotificationPreferenceChannel as g4, type UserOnboardingStepsTypes as g5, type UserReceiptFilters as g6, type UserReceiptOrder as g7, type UserReceiptPaidTypeFilter as g8, type UserSocialLinkWebsites as g9, type WithdrawalSpeeds as gA, type WithdrawalStatus as gB, type WithdrawalTypes as gC, type WithdrawalsSortableColumns as gD, type AccessPassFragmentFragment as gE, type BaseAppBuildFragment as gF, type AttachmentFragment as gG, type BaseAuthorizedUserFragment as gH, type BaseLedgerAccountFragment as gI, type BasePublicPlanFragment as gJ, type BasePlanFragment as gK, type BaseReceiptFragment as gL, type BaseUserFragment as gM, type BasePublicProfileUserFragment as gN, type BasicCourseFragment as gO, type BasicCourseChapterFragment as gP, type BasicCourseLessonFragment as gQ, type CompanyFragmentFragment as gR, type ExperienceFragmentFragment as gS, type PublicExperienceFragmentFragment as gT, type ForumPostFragmentFragment as gU, type FullCourseLessonFragment as gV, type CourseMuxAssetFragment as gW, type CourseAssessmentQuestionFragment as gX, type MessageFragment as gY, type GetAccessPassQueryVariables as gZ, type GetAccessPassQuery as g_, type UserTypes as ga, type ValidMembershipsOrder as gb, type VaultMethods as gc, type VaultTokenProviders as gd, type VerificationErrorCodes as ge, type VerificationProviders as gf, type VerificationStatuses as gg, type VerifiedStatuses as gh, type VersionEventTypes as gi, type VersionFilters as gj, type VersionObjects as gk, type VersionOrder as gl, type Visibility as gm, type VisibilityFilter as gn, type WebhookEvent as go, type WeeklyAnchors as gp, type WhoCanPostTypes as gq, type WhoCanReactTypes as gr, type WhopSidebarFilters as gs, type WhopSidebarOrderEnum as gt, type WhopSidebarWithEarningsFilters as gu, type WhopSidebarWithEarningsOrderEnum as gv, type WithdrawalFeeTypes as gw, type WithdrawalFilters as gx, type WithdrawalMethods as gy, type WithdrawalProviders as gz, type CreateAssessmentQuestionMutation$1 as h, type ListAccessPassesForExperienceQueryVariables as h$, type CheckIfUserHasAccessToAccessPassQuery as h0, type CheckIfUserHasAccessToCompanyQueryVariables as h1, type CheckIfUserHasAccessToCompanyQuery as h2, type CheckIfUserHasAccessToExperienceQueryVariables as h3, type CheckIfUserHasAccessToExperienceQuery as h4, type CreateAppBuildMutationVariables as h5, type CreateAppBuildMutation as h6, type GetAttachmentQueryVariables as h7, type GetAttachmentQuery as h8, type ProcessAttachmentMutationVariables as h9, type DeleteLessonAttachmentMutation as hA, type DeleteLessonMutationVariables as hB, type DeleteLessonMutation as hC, type GetCourseQueryVariables as hD, type GetCourseQuery as hE, type GetLessonQueryVariables as hF, type GetLessonQuery as hG, type GetUserLessonInteractionsQueryVariables as hH, type GetUserLessonInteractionsQuery as hI, type ListCoursesForCompanyQueryVariables as hJ, type ListCoursesForCompanyQuery as hK, type ListCoursesForExperienceQueryVariables as hL, type ListCoursesForExperienceQuery as hM, type MarkLessonAsCompletedMutationVariables as hN, type MarkLessonAsCompletedMutation as hO, type MoveCourseMutationVariables as hP, type MoveCourseMutation as hQ, type UpdateChapterOrderMutationVariables as hR, type UpdateChapterOrderMutation as hS, type UpdateChapterMutationVariables as hT, type UpdateChapterMutation as hU, type UpdateLessonOrderMutationVariables as hV, type UpdateLessonOrderMutation as hW, type UpdateLessonMutationVariables as hX, type UpdateLessonMutation as hY, type GetExperienceQueryVariables as hZ, type GetExperienceQuery as h_, type ProcessAttachmentMutation as ha, type UploadMediaMutationVariables as hb, type UploadMediaMutation as hc, type GetCompanyAuthorizedUsersQueryVariables as hd, type GetCompanyAuthorizedUsersQuery as he, type GetCompanyLedgerAccountQueryVariables as hf, type GetCompanyLedgerAccountQuery as hg, type GetCompanyQueryVariables as hh, type GetCompanyQuery as hi, type GetWaitlistEntriesForCompanyQueryVariables as hj, type GetWaitlistEntriesForCompanyQuery as hk, type ListMembersQueryVariables as hl, type ListMembersQuery as hm, type CreateAssessmentQuestionMutationVariables as hn, type CreateAssessmentQuestionMutation as ho, type CreateChapterMutationVariables as hp, type CreateChapterMutation as hq, type CreateCourseMutationVariables as hr, type CreateCourseMutation as hs, type CreateLessonMutationVariables as ht, type CreateLessonMutation as hu, type DeleteAssessmentQuestionImageMutationVariables as hv, type DeleteAssessmentQuestionImageMutation as hw, type DeleteChapterMutationVariables as hx, type DeleteChapterMutation as hy, type DeleteLessonAttachmentMutationVariables as hz, type CreateChapterInput$1 as i, type ListAccessPassesForExperienceQuery as i0, type ListExperiencesQueryVariables as i1, type ListExperiencesQuery as i2, type ListUsersForExperienceQueryVariables as i3, type ListUsersForExperienceQuery as i4, type CreateForumPostMutationVariables as i5, type CreateForumPostMutation as i6, type FindOrCreateForumMutationVariables as i7, type FindOrCreateForumMutation as i8, type ListForumPostsFromForumQueryVariables as i9, type GetUserLedgerAccountQuery as iA, type GetUserQueryVariables as iB, type GetUserQuery as iC, type Requester as iD, getSdk as iE, type Sdk as iF, type ListForumPostsFromForumQuery as ia, type FindOrCreateChatMutationVariables as ib, type FindOrCreateChatMutation as ic, type ListDirectMessageConversationsQueryVariables as id, type ListDirectMessageConversationsQuery as ie, type ListMessagesFromChatQueryVariables as ig, type ListMessagesFromChatQuery as ih, type SendDirectMessageToUserMutationVariables as ii, type SendDirectMessageToUserMutation as ij, type SendMessageToChatMutationVariables as ik, type SendMessageToChatMutation as il, type SendPushNotificationMutationVariables as im, type SendPushNotificationMutation as io, type ChargeUserMutationVariables as ip, type ChargeUserMutation as iq, type CreateCheckoutSessionMutationVariables as ir, type CreateCheckoutSessionMutation as is, type ListReceiptsForCompanyQueryVariables as it, type ListReceiptsForCompanyQuery as iu, type PayUserMutationVariables as iv, type PayUserMutation as iw, type GetCurrentUserQueryVariables as ix, type GetCurrentUserQuery as iy, type GetUserLedgerAccountQueryVariables as iz, type CreateChapterMutation$1 as j, type CreateCourseInput$1 as k, type CreateCourseMutation$1 as l, type CreateLessonInput$1 as m, type CreateLessonMutation$1 as n, type DeleteAssessmentQuestionImageInput$1 as o, type DeleteAssessmentQuestionImageMutation$1 as p, type DeleteChapterInput$1 as q, type DeleteChapterMutation$1 as r, type DeleteLessonAttachmentInput$1 as s, type DeleteLessonAttachmentMutation$1 as t, type DeleteLessonInput$1 as u, type DeleteLessonMutation$1 as v, type GetCourseQuery$1 as w, type GetLessonQuery$1 as x, type GetUserLessonInteractionsQuery$1 as y, type ListCoursesForExperienceQuery$1 as z };
